...
`,p=t.p`
  ...
  line-height: 1.5;
  word-spacing: 2px;
`;function E(n){return d({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"}}]})(n)}function W(n){return d({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"}}]})(n)}const G=({item:n,favoriteIcon:r})=>{const l=y(C),{img:s,make:x,model:c,year:g,rentalPrice:h,address:u,rentalCompany:m,type:f,engineSize:w,mileage:b}=n,j=u.split(", ").slice(1,3).join(" | "),v=b.toLocaleString("en-IN"),o=q();return e.jsxs(T,{children:[e.jsxs(B,{children:[e.jsx(M,{src:s||R}),e.jsx(F,{}),e.jsx(S,{type:"button",onClick:r?()=>o(z(n.id)):()=>o(k(n)),children:r?e.jsx(W,{}):e.jsx(E,{})})]}),e.jsxs(P,{children:[e.jsx(a,{children:`${x}, ${g}`}),e.jsx(a,{children:h})]}),e.jsxs(D,{children:[e.jsx(p,{children:`${j} | ${m}`}),e.jsx(p,{children:`${f}  |  ${c}  |  ${w}  |  ${v}`})]}),e.jsx(L,{title:"Learn more",type:"button",onClick:()=>{o(I(!l)),o($(n))}})]})};G.propTypes={item:i.shape({id:i.number.isRequired,img:i.string,make:i.string.isRequired,model:i.string.isRequired,year:i.number.isRequired,rentalPrice:i.string.isRequired,address:i.string.isRequired,rentalCompany:i.string.isRequired,type:i.string.isRequired,engineSize:i.string.isRequired,mileage:i.number.isRequired}),favoriteIcon:i.bool.isRequired};const A=t.ul`
  display: flex;
  width: 320px;
